...
/* WEBPACK VAR INJECTION */(function($) {$('.js-generate-button').on('click', function (e) {
  ...
  var urlsId = $('input[name="urls_id"]').val();
  var fromTime = $('input[name="from_time"]').val();
  var untilTime = $('input[name="until_time"]').val();
  var visitDurationId = $('input[name="visit_duration_id"]').val();
  ...
  if (delId !== "") {
    if (fromValue === "visits") {
      $('.js-output-area').append("<div>\n          <input type=\"checkbox\" id=\"visits_delete_value-".concat(delId, "\">\n          <label for=\"visits_delete_value-").concat(delId, "\">").concat(sql01, "</label>\n        </div>"));
    } else {
      $('.js-output-area').append("<div>\n          <input type=\"checkbox\" id=\"urls_delete_value-".concat(delId, "\">\n          <label for=\"urls_delete_value-").concat(delId, "\">").concat(sql01, "</label>\n        </div>"));
    }
  }
...
$('.js-export-button').on('click', function (e) {
  var sqlArr = $('.js-output-area').find('label');
  var sqlQuery = sqlArr.map(function () {
    return $(this).text() + '\n';
  }).get().join('');
...
/***/ 1:
/*!********************************************!*\
  !*** multi ./resources/js/sqlgenerator.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/ubuntu/environment/chrome-history-editor/resources/js/sqlgenerator.js */"./resources/js/sqlgenerator.js");
